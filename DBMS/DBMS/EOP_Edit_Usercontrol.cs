...
namespace DBMS
{
    public partial class EOP_Edit_Usercontrol : UserControl
    {
        MySqlConnection con = new MySqlConnection("Server=127.0.0.1;Database=cement_industry;Uid=root;Pwd=1020");

        private static EOP_Edit_Usercontrol _instance;
        public static EOP_Edit_Usercontrol Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new EOP_Edit_Usercontrol();
        ...
        public void Refresh_Data_Grid()
        {
            try
            {
                MySqlCommand cmd = new MySqlCommand("EOP_Refresh_SP", con);
        ...
        private void EOP_Edit_Usercontrol_Load(object sender, EventArgs e)
        {
            Refresh_Data_Grid();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            pms[1] = new MySqlParameter("iProject_ID", MySqlDbType.VarChar);
            pms[1].Value = textBox7.Text;
            pms[2] = new MySqlParameter("iDept_ID", MySqlDbType.VarChar);
            pms[2].Value = textBox5.Text;


            MySqlCommand cmd = new MySqlCommand("EOP_Add_SP", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                MySqlCommand cmd = new MySqlCommand("EOP_Delete_SP", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                MySqlCommand cmd = new MySqlCommand("EOP_Search_SP", con);
                cmd.CommandType = CommandType.StoredProcedure;
            ...
            {
                con.Open();
                MySqlCommand cmd1 = new MySqlCommand("EOP_Search_SP", con);
                ...
                try
                {
                    while (dr.Read())
                    {
                        ...
                        textBox7.Text = ecn;
                        string eei = dr.GetString("Dept_ID");
                        textBox5.Text = eei;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            pms[0] = new MySqlParameter("iEmp_ID", MySqlDbType.VarChar);
            pms[0].Value = textBox8.Text;
            pms[1] = new MySqlParameter("iProject_ID", MySqlDbType.Int32);
            pms[1].Value = textBox7.Text;
            pms[2] = new MySqlParameter("iDept_ID", MySqlDbType.VarChar);
            pms[2].Value = textBox5.Text;

            MySqlCommand cmd = new MySqlCommand("EOP_Update_SP", con);
            cmd.CommandType = CommandType.StoredProcedure;
