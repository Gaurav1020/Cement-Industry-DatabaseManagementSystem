...
namespace DBMS
{
    public partial class RM_Edit_Usercontrol : UserControl
    {
        MySqlConnection con = new MySqlConnection("Server=127.0.0.1;Database=cement_industry;Uid=root;Pwd=1020");

        private static RM_Edit_Usercontrol _instance;
        public static RM_Edit_Usercontrol Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new RM_Edit_Usercontrol();

                }
                return _instance;
            }
        }
        public RM_Edit_Usercontrol()
        {
            InitializeComponent();
        }
        ...
        public void Refresh_Data_Grid()
        {
            try
            {
                MySqlCommand cmd = new MySqlCommand("RM_Refresh_SP", con);
        ...
        private void RM_Edit_Usercontrol_Load(object sender, EventArgs e)
        {
            Refresh_Data_Grid();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            pms[1] = new MySqlParameter("iRM_Name", MySqlDbType.VarChar);
            pms[1].Value = textBox7.Text;


            MySqlCommand cmd = new MySqlCommand("RM_Add_SP", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("RM_Update_SP", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                MySqlCommand cmd = new MySqlCommand("RM_Delete_SP", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                MySqlCommand cmd = new MySqlCommand("RM_Search_SP", con);
                cmd.CommandType = CommandType.StoredProcedure;
            ...
            {
                con.Open();
                MySqlCommand cmd1 = new MySqlCommand("RM_Search_SP", con);
                ...
                try
                {
                    while (dr.Read())
                    {
                        ...
                        textBox8.Text = eid;
                        string ecn = dr.GetString("Raw_Material_Name");
                        textBox7.Text = ecn;
